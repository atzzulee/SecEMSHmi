...
using SecEMSHmi.Models;

namespace SecEMSHmi.Controllers
{
    [Authorize]
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetTwoFactorSuccess ? "2단계 인증 공급자가 설정되었습니다."
                : message == ManageMessageId.Error ? "오류가 발생했습니다."
                : message == ManageMessageId.AddPhoneSuccess ? "전화 번호가 추가되었습니다."
                : message == ManageMessageId.RemovePhoneSuccess ? "전화 번호가 제거되었습니다."
                : "";
        ...
        public async Task<ActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            ...
            // SMS 공급자를 통해 SMS를 보내어 전화 번호를 확인합니다.
